...
<?php
	...
	$grounds = getRequest($urlServices . 'grounds');
					...
					<ul>	
						<li style="margin-bottom:7px">
							...
							<?php foreach ($states as $stateIT) { ?>
								<li>
									<a href="" onclick="$.loadFilter(<?php echo  '{state:\'' . $stateIT->{'name'} . '\',sport:\'' . $sport . '\',district:\'' .$district. '\',ground:\'' . $ground . '\',hour:\'' .$hour. '\',day:\'' . $day . '\',view:\'' . $view . '\'}'  ?>);">
						...
						<li style="margin-bottom:7px">
							...
							<ul>
								...
								<li>
									<a href="" onclick="$.loadFilter(<?php echo  '{state:\'' . $state . '\',sport:\'' . $sport . '\',district:\'' .$district. '\',ground:\'' . $groundIT->{"name"} . '\',hour:\'' .$hour. '\',day:\'' . $day . '\',view:\'' . $view . '\'}'  ?>);">
										<?php echo $groundIT->{"name"} ?> 
									</a>
								</li>
								<?php }	?>
							</ul>
